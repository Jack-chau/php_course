...
//        $sql = "SELECT id, name, class, updated_at FROM student " ;
        $sql = "SELECT student.id, student.name, class.name AS classname, student.updated_at
                FROM student INNER JOIN class on student.class = class.id" ;
        ...
        echo "<table border='1'>\n" ;
            ...
            while( $result = $stmt -> fetch( ) ){
                echo "<tr>\n" ;
                    ...
                    echo "<a name='delete' href='dbdelete.php?id=".$result[ 'id' ]."'>Delete</a>" ;
                    echo "</td>\n" ;
                echo "</tr>\n" ;
            }
        echo "</table>\n" ;
